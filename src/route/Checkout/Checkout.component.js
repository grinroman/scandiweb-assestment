import { Checkout as SourseHeader } from 'SourceRoute/Checkout/Checkout.component'
...
class Checkout extends SourseHeader {
    ...
    myRender() {
        return (<ProgressBar elementsAmount={2} stage={0}/>)
    }
